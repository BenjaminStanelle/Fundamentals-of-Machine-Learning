There is a python implementation of the multiperceptron neural network as well as a C++ implementation where I try to optimize the runtime of the program.
